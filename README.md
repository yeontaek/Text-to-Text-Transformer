...
```
Input 문장 : 2008년 <MASK> <MASK> 복싱 남자 라이트급 경기는 *호텔* 도시인 베이징에 있는 <MASK> <MASK> 체육관에서 경기가 열렸다.


Target 문장 : 2008년 하계 올림픽 복싱 남자 라이트급 경기는 개최 도시인 베이징에 있는 베이징 노동자 체육관에서 경기가 열렸다. (original text)
```
